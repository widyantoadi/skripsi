  ...
  <?=$this->session->flashdata('pesan')?>
       ...
       <table class="table table-striped">
         ...
         <tr>
          ...
          <td>
            <div class="col-sm-2">
                <input type="text" name="kode_calon" class="form-control" readonly="readonly" value="<?php echo $kode_calon;?>">
            </div>
            </td>
         </tr>
         ...
         <tr>
          ...
          <td>
          <div class="col-sm-4">
            <input type="text" name="nama_calon" class="form-control" value="" required>
          </div>
          </td>
         </tr>
         <tr>
       ...
       <tr>
          ...
          <td>
           <div class="col-sm-4">
            <input class="form-control datepicker"  data-date-format="yyyy-mm-dd" type="text" name="tgl_lahir" style="width:150px" required>
            </div>
           </td>
         </tr>
         <tr>
          ...
          <td>
            <div class="col-sm-4">
                <input type="text" name="pendidikan_terakhir" class="form-control" value="" required>
            </div>
            </td>
         </tr>
         <tr>
          ...
          <td>
            <div class="col-sm-4">
                <input type="number" size="2" name="anak_ke" class="form-control" value="" required>
            </div>
            </td>
         </tr>
         <tr>
          ...
          <td>
            <div class="col-sm-4">
                <input type="number" size="2" name="dari" class="form-control" value="" required>
            </div>
            </td>
         </tr>
          <tr>
          ...
          <td>
            <div class="col-sm-4">
                <input type="text" name="nama_bapak" class="form-control" value="" required>
            </div>
            </td>
         </tr>
          <tr>
          ...
          <td>
            <div class="col-sm-4">
                <input type="text" name="alamat_bapak" class="form-control" value="" required>
            </div>
            </td>
         </tr>
          <tr>
          ...
          <td>
            <div class="col-sm-4">
                <input type="text" name="pekerjaan_bapak" class="form-control" value="" required>
            </div>
            </td>
         </tr>
          <tr>
          ...
          <td>
            <div class="col-sm-4">
                 <input class="form-control datepicker"  data-date-format="yyyy-mm-dd" type="text" name="tgl_meninggal_bapak" style="width:150px" value="0000-00-00">
            </div>
            </td>
         </tr>
         <tr>
          ...
          <td>
            <div class="col-sm-4">
                <input type="text" name="nama_ibu" class="form-control" value="" required>
            </div>
            </td>
         </tr>
          <tr>
          ...
          <td>
            <div class="col-sm-4">
                <input type="text" name="alamat_ibu" class="form-control" value="" required>
            </div>
            </td>
         </tr>
          <tr>
          ...
          <td>
            <div class="col-sm-4">
                <input type="text" name="pekerjaan_ibu" class="form-control" value="" required>
            </div>
            </td>
         </tr>
          <tr>
          ...
          <td>
            <div class="col-sm-4">
                 <input class="form-control datepicker"  data-date-format="yyyy-mm-dd" type="text" name="tgl_meninggal_ibu" style="width:150px" value="0000-00-00">
            </div>
            </td>
         </tr>
         <tr>
          ...
          <td>
            <div class="col-sm-4">
                <input type="text" name="alamat_wali" class="form-control" value="">
            </div>
            </td>
         </tr>
          <tr>
         ...
         <input type="hidden" name="status_ketentuan" value="belum_lolos">
         <tr>
          <td colspan="2">
