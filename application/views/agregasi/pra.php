...
<link href="<?php echo base_url()?>assets/a/date_picker_bootstrap/bootstrap-datetimepicker.min.css" rel="stylesheet" media="screen">
 ...
 <link href="../assets1/jquery/jquery-ui.css" rel="stylesheet">
  ...
  <title>Laporan Kategori Pengeluaran Kas Terbesar Anak Asuh</title>

<?php
echo form_open('agregasi');
?>
...
<div class="container">
  <h2>Laporan Kategori Pengeluaran Kas Terbesar Anak Asuh</h2>
 
      <!-- Main component for a primary marketing message or call to action -->
<div class="panel panel-default">
  
  <div class="panel-heading"><b> Laporan Kategori Pengeluaran Kas Terbesar Anak Asuh</b></div>
